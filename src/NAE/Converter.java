...
//        String name = modelFileName.split("\\.")[0]+".smv";
    ...
    void createNode(String line){
        ...
        /***************************************
         * in case there is a special node, skip 
         ***************************************/
        if(f.length == 1 && f[0] != 81){
    ...
    void createConnection(String line){
        ...
        */
        ...
        /******************************************************************************************
         * if target is a special node we expect to "weak"/"strong" declaration for each connection
         ******************************************************************************************/
        if (n.functions[0] == 81){
        	boolean isStrong = tokens[3].equals("strong");
            optional = tokens.length>4;
            input = new Input(name,isPositive,optional,isStrong);
        }
        else{
            optional = tokens.length>3;
            input = new Input(name,isPositive,optional);
        }
